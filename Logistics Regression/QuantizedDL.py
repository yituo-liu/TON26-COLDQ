...
def QuantizedDL(N, total_step, D, d, C, Data, Label):
    x_max = 0.005
    constraint_summary = []
...
# Simulation
Loss_QuantizedDL, Cons_QuantizedDL, Acc_QuantizedDL, Ent_QuantizedDL = QuantizedDL(N, total_step, D, d, C, Data, Label)
...
Ent_QuantizedDL_adjusted = adjust_entropy(Ent_QuantizedDL, 7840)

Cons_QuantizedDL = cumulative_average(Cons_QuantizedDL)

plt.figure(figsize=(20, 12))

plt.subplot(2, 2, 1)
plt.plot(Acc_QuantizedDL[1:500], label="QuantizedDL", color="orange", linestyle='-.', linewidth=2)
...
plt.subplot(2, 2, 2)
plt.plot(Loss_QuantizedDL[1:500], label="QuantizedDL", color="orange", linestyle='-.', linewidth=2)
plt.xlabel("Time", fontsize=24, fontdict={'fontname': 'Times New Roman'})
...
plt.subplot(2, 2, 3)
plt.plot(Ent_QuantizedDL_adjusted[1:500], label="QuantizedDL", color="orange", linestyle='-.', linewidth=2)
plt.xlabel("Time", fontsize=24, fontdict={'fontname': 'Times New Roman'})
...
plt.subplot(2, 2, 4)
plt.plot(Cons_QuantizedDL[1:500], label="QuantizedDL", color="orange", linestyle='-.', linewidth=2)
plt.xlabel("Time", fontsize=24, fontdict={'fontname': 'Times New Roman'})

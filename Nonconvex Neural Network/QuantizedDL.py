...
for t in range(T):
    ...
    if (t+1) % 1 == 0:
        ...
        print("t: {} Accuracy: {} Cons: {} Ent: {}".format(t+1, plot_accuracy[t], constraint_summary[t], Entropy[t]))
...
plt.subplot(1, 2, 1)
plt.plot(plot_accuracy[1:T], label="QuantizedDL", color="red", linewidth=2)
...
plt.subplot(1, 2, 2)
plt.plot(Ent_adjusted[1:T], label="Quantized DL", color="red", linewidth=2)
plt.xlabel("Time", fontsize=24, fontdict={'fontname': 'Times New Roman'})
